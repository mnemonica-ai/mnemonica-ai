...
export const apps: App[] = [
  ...
  {
    name: "Taper Player",
    url: "https://github.com/p1nox/taper-player",
    label: "github",
    monogram: "Tp",
    accent: "#f97316",
    accentText: "#fdba74",
  ...
  {
    name: "Red Teaming Latent Spaces",
    url: "https://github.com/p1nox/red-teaming-latent-spaces",
    label: "github",
    monogram: "Rt",
    accent: "#ef4444",
    accentText: "#fca5a5",
  ...
  {
    name: "GAN Ensembles",
    url: "https://github.com/p1nox/gan_ensembles",
    label: "github",
    monogram: "Ge",
    accent: "#22c55e",
    accentText: "#86efac",
